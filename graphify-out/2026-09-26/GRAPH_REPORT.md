...
## Knowledge Gaps
- **397 isolated node(s):** `paths`, `webhooks`, `$defs`, `operations`, `ModelProbabilityBarProps` (+392 more)
...
- **Why does `PredictionService` connect `PredictionService` to `Fixture`, `test_pipeline.py`, `predictions.py`?**
